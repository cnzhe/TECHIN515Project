...
long distance;  // this value holds the distance measured by the VL53L0X sensor (in mm)
float weight;  // this value holds the weight measured by the HX711 sensor (in g)
