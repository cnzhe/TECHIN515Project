...
// Define user agent string for the Azure SDK client
#define AZURE_SDK_CLIENT_USER_AGENT "c%2F" AZ_SDK_VERSION_STRING "(ard;esp32)"

// Utility macros and defines
#define sizeofarray(a) (sizeof(a) / sizeof(a[0])) // Macro to get the number of elements in an array
#define NTP_SERVERS "pool.ntp.org", "time.nist.gov" // NTP servers for time synchronization
#define MQTT_QOS1 1 // MQTT Quality of Service level 1
#define DO_NOT_RETAIN_MSG 0 // Do not retain MQTT messages
#define SAS_TOKEN_DURATION_IN_MINUTES 60 // SAS token validity duration
#define UNIX_TIME_NOV_13_2017 1510592825 // Unix time for November 13, 2017

// Time zone definitions for PST (Pacific Standard Time)
#define PST_TIME_ZONE -8
#define PST_TIME_ZONE_DAYLIGHT_SAVINGS_DIFF 1

#define GMT_OFFSET_SECS (PST_TIME_ZONE * 3600) // GMT offset in seconds for PST
#define GMT_OFFSET_SECS_DST ((PST_TIME_ZONE + PST_TIME_ZONE_DAYLIGHT_SAVINGS_DIFF) * 3600) // DST offset in seconds for PST

// WiFi and MQTT connection details from iot_configs.h
...
// Memory allocated for various variables and structures
...
// Include libraries for VL53L0X and HX711 sensors
...
long distance; // Variable to hold the distance measured by the VL53L0X sensor (in mm)
float weight; // Variable to hold the weight measured by the HX711 sensor (in g)

// SAS token setup (if not using X509 certificates)
...
static void initializeTime()
{
  ...
  configTime(GMT_OFFSET_SECS, GMT_OFFSET_SECS_DST, NTP_SERVERS); // Configure time using NTP servers
...
// Function to establish the connection to WiFi and IoT Hub
...
// Function to generate the telemetry payload
...
void loop()
{
  ...
  { 
    ...
    // Prints the distance and weight in the Serial Monitor
